...
auto Sorcery::MonsterType::get_type_id() const -> Enums::Monsters::TypeID {
...
auto Sorcery::MonsterType::get_class() const -> Enums::Monsters::Class {
...
auto Sorcery::MonsterType::get_category() const -> Enums::Monsters::Category {
...
auto Sorcery::MonsterType::set_resistances(std::array<bool, 7> value) -> void {

	_resistances = value;
}

auto Sorcery::MonsterType::set_properties(std::array<bool, 7> value) -> void {
...
auto Sorcery::MonsterType::get_properties() const -> std::array<bool, 7> {

	return _properties;
}

auto Sorcery::MonsterType::get_resistances() const -> std::array<bool, 7> {
